...
public class DuplicateCheckService {
    ...
    public void processDuplicateCheck(String emailAddress, String sourceSystem, MultipartFile file) {
        ...
        log.info(String.format("Received DuplicateCheck: email=%s", emailAddress));
        ...
        try {
            ...
            log.error(String.format("p: Failed to insert duplicate-check: duplicateCheckId=%d, customerId=%d", duplicateCheckId, customerId), ex);
