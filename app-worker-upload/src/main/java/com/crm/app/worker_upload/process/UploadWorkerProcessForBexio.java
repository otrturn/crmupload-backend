...
public class UploadWorkerProcessForBexio {
    ...
    public void processUploadForEspo(CrmUploadContent upload) {
        ...
        try {
            ...
            Map<BexioColumn, Integer> indexMap = new ReadBexioExcel(ctx).getEntries(upload.getContent(), bexioEntries, errors);
            ...
            MyBexioToEspoMapper.toEspoAccounts(ctx, bexioEntries, espoEntityPoolForReceived, errors, indexMap);
